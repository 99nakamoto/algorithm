...
public class OnlyOneConnectedComponent {

    public static void main(String[] args) {
        OnlyOneConnectedComponent ins = new OnlyOneConnectedComponent();
    ...
    private boolean isValidCrosswordO1(int[][] puzzle){
    //4-connectivity
