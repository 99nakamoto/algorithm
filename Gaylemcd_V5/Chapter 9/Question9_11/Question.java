...
public class Question {
	...
	private static void test(String exp) {
		...
		bruteForce(exp, new HashMap<String, Boolean>(), result,
				new boolean[(exp.length() - 1) / 2]);

		System.out.print("Recursive: ");
		System.out.println(countR(exp, result, 0, exp.length() - 1));

		System.out.print("DP: ");
		System.out.println(countDP(exp, result, 0, exp.length() - 1,
				new HashMap<String, Integer>()));

		System.out.print("DP efficient: ");
		System.out.println(countDPEff(exp, result, 0, exp.length() - 1,
				new HashMap<String, Integer>()));

		System.out.print("My solution: ");
		System.out.println(MyAnswer.countMyAnswer(exp, result));
		System.out.println();
	}
