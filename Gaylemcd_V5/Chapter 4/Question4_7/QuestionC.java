...
public class QuestionC {
	...
	public static Result commonAncestorHelper(TreeNode root, TreeNode p,
			TreeNode q) {
		if (root == null) {
		...
		if (rx.node != null && ry.node != null) {
			 ...
			 * in a subtree, then this is truly an ancestor and the flag should
			 * be true.
			 */
			boolean isAncestor = rx.node != null || ry.node != null ? true
					: false;
